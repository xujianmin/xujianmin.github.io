...
> Ryan Bates, http://railscasts.com/episodes/238-mongoid-revised?view=asciicast, Ruby on Rails Screencastsx
...
既然我们已经有了一个运行着的MongoDB，我们将创建一个名叫store的Rails应用。因为我们希望使用Mongoid而不是ActiveRecord，我们将使用--skip-active-record的选项。这样rails在新建应用时就不会载入相关的数据库配置的框架和生成文件，例如数据库配置文件。
...
![1](/assets/images/20140203/pic01.png)
...
![2](/assets/images/20140203/pic02.png)
...
![3](/assets/images/20140203/pic03.png)
...
![4](/assets/images/20140203/pic04.png)
